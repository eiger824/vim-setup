...
let s:colors = {
      ...
      \ "green": get(s:overrides, "green", { "gui": "#5FD700", "cterm": "76", "cterm16": "2" }),
      \ "yellow": get(s:overrides, "yellow", { "gui": "#E5C07B", "cterm": "180", "cterm16": "3" }),
      \ "dark_yellow": get(s:overrides, "dark_yellow", { "gui": "#D19A66", "cterm": "11", "cterm16": "11" }),
      ...
      \ "white": get(s:overrides, "white", { "gui": "#DADADA", "cterm": "253", "cterm16": "7" }),
      \ "black": get(s:overrides, "black", { "gui": "#282C34", "cterm": "235", "cterm16": "0" }),
      \ "visual_black": get(s:overrides, "visual_black", { "gui": "NONE", "cterm": "NONE", "cterm16": "0" }),
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#D75F00", "cterm": "166", "cterm16": "15" }),
